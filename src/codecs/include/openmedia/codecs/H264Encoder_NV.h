...
class H264Encoder_NV : public IEncoder {
public:
    H264Encoder_NV();
    ~H264Encoder_NV() override;

    std::string GetName() const override { return "H264Encoder_NV"; }
...
private:
    ...
    void* m_nvencSession = nullptr; // NV_ENCODE_API_FUNCTION_LIST
