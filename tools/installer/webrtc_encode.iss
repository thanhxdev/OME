; =====================================================================
; OpenMedia - WEBRTC_ENCODE Inno Setup 6 Script
...
#define MyAppName "WEBRTC_ENCODE"
#define MyAppExeName "WEBRTC_ENCODE.exe"
#define MyAppPublisher "OpenMedia Project"
#define MyAppURL "https://github.com/openmedia/openmedia"
#define AppGuid "{{C4D95371-8BB3-4E7D-92C2-43DA3E567890}}"

#ifndef SourceDir
  #define SourceDir "..\..\dist\apps\WEBRTC_ENCODE"
#endif
  ...
  #define OutputBaseFilename "WEBRTC_ENCODE_Setup"
#endif
