; =====================================================================
; OpenMedia - SRT_ENCODE Inno Setup 6 Script
...
#define MyAppExeName "SRT_ENCODE.exe"
...
#define AppGuid "{{B3C84260-6FF1-4D6C-81A1-21B91E345678}}"
...
#ifndef SourceDir
  #define SourceDir "..\..\dist\apps\SRT_ENCODE"
#endif
  ...
  #define OutputBaseFilename "SRT_ENCODE_Setup"
#endif
