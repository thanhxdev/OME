; =====================================================================
; OpenMedia - WEBRTC_DECODE Inno Setup 6 Script
...
#define MyAppName "WEBRTC_DECODE"
#define MyAppExeName "WEBRTC_DECODE.exe"
#define MyAppPublisher "OpenMedia Project"
#define MyAppURL "https://github.com/openmedia/openmedia"
#define AppGuid "{{F8EA2481-9CC4-4F8E-A3D3-54EB4F678901}}"

#ifndef SourceDir
  #define SourceDir "..\..\dist\apps\WEBRTC_DECODE"
#endif
  ...
  #define OutputBaseFilename "WEBRTC_DECODE_Setup"
#endif
